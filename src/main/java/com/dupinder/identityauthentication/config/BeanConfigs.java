...
import com.dupinder.identityauthentication.core.service.PasswordEncryptor;
import com.dupinder.identityauthentication.external.tenancy.TenancyResolver;
import com.dupinder.identityauthentication.external.tenancy.TenancyResolverStub;
...
public class BeanConfigs {
    ...
    @Bean public PasswordEncryptor passwordEncryptor() { return new PasswordEncryptor(new BCryptPasswordEncoder());}
    @Bean public TenancyResolver resolveTenancy() { return new TenancyResolverStub();}
